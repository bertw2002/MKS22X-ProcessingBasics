...
void gasket(int levels, float v1x, float v1y, float v2x, float v2y, float v3x, float v3y) {
  if( levels == 0 ){
    ...
    return;// need to return so nothing happens after.
  }else{
    triangle(v1x, v1y, v2x, v2y, v3x, v3y);
    gasketHelp(levels, v1x, v1y, v2x, v2y, v3x, v3y);
  }

}
void gasketHelp(int levels, float v1x, float v1y, float v2x, float v2y, float v3x, float v3y) {
  if(levels >= 1){
  triangle((v1x + v3x) / 2,(v1y + v3y) / 2,(v2x + v1x) / 2,(v2y + v1y) / 2,(v3x + v2x) / 2,(v3y + v2y) / 2);
  gasketHelp(levels - 1, v1x, v1y, (v2x + v1x) / 2, (v2y + v1y) / 2, (v1x + v3x) / 2, (v1y + v3y) / 2);
  gasketHelp(levels - 1, (v1x + v3x) / 2, (v1y + v3y) / 2, (v3x + v2x) / 2,(v3y + v2y) / 2, v3x, v3y);
  gasketHelp(levels - 1, (v2x + v1x) / 2, (v2y + v1y) / 2, v2x, v2y, (v3x + v2x) / 2, (v3y + v2y) / 2);
